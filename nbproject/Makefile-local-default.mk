...
#
PATH_TO_IDE_BIN=/Applications/microchip/mplabx/v5.15/mplab_platform/platform/../mplab_ide/modules/../../bin/
# Adding MPLAB X bin directory to path.
PATH:=/Applications/microchip/mplabx/v5.15/mplab_platform/platform/../mplab_ide/modules/../../bin/:$(PATH)
# Path to java used to run MPLAB X when this makefile was created
MP_JAVA_PATH="/Applications/microchip/mplabx/v5.15/sys/java/jre1.8.0_181.jre/Contents/Home/bin/"
...
DEP_GEN=${MP_JAVA_PATH}java -jar "/Applications/microchip/mplabx/v5.15/mplab_platform/platform/../mplab_ide/modules/../../bin/extractobjectdependencies.jar"
